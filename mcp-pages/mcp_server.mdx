...
Looking to use MCP tools _inside_ a Vapi assistant? See the [**<u>MCP Tool documentation</u>**](https://docs.vapi.ai/tools/mcp) for integrating _external_ MCP servers with your Vapi agents.
